...
//			addSequential(new commonCG_driveAroundSwitchRight());
			...
			addSequential(new auto_resetEncoder());
			addSequential(new auto_driveToAngleWithEncoder(-.5, 3, 0, 22000, 22000, 0.04));
			addSequential(new auto_clawOpen());
			
			addSequential(new auto_gyroMMTurn(-75, 0.75));
			
			addParallel(new auto_driveToAngleWithEncoder(.7, 8, -75, 75000, 75000, 0.025, true));
			addSequential(new auto_wait(1.5));
			addParallel(new auto_intake_in(.7, 1));
