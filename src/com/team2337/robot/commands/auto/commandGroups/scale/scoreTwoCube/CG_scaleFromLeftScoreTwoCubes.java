...
public class CG_scaleFromLeftScoreTwoCubes extends CommandGroup {

	String ourSwitch, scale;
	public CG_scaleFromLeftScoreTwoCubes(String ourSwitch, String scale) {
		...
		// Score Scale, get cube, Score Scale, get cube,  Score Scale	//LLL AND RLR
				if  (scale.equals("L")) {
					...
					//Score second cube//
					addSequential(new auto_driveToAngleWithEncoder(.5, 10, 35, 20000, 120000, .13));
					addSequential (new auto_gyroMMTurn(-90, 1));
