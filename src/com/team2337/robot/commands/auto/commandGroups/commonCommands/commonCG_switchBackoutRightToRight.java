...
/**
 * Scores first cube in the right switch, then backs out to the right
 */
public class commonCG_switchBackoutRightToRight extends CommandGroup {

	public commonCG_switchBackoutRightToRight() {
