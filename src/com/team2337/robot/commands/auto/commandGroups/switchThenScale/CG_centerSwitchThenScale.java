...
//				addSequential(new auto_driveToAngleWithEncoder(.5, 8, -75, 47000, 47000, 0.02, true, 0.64));
			addSequential(new auto_driveToAngleWithEncoder(.7, 8, -75, 101000, 101000, 0.03, true));    //-38
