...
package com.team2337.robot.commands.auto.profiles;
...
public class MotionProfileManager {
	...
	/**
	 * Calculated based on 4096 * 3.3333333333 gear ratio for our robot.
	 */
	private int kSensorUnitsPerRotation = 13653;
	...
	private void startFilling(double[][] profile, int totalCnt) {
		...
		if (_status.hasUnderrun) {
			 ...
			 */
			_motorController.clearMotionProfileHasUnderrun(timeoutMs);
		}
		/*
		...
		_motorController.configMotionProfileTrajectoryPeriod(kBaseTrajPeriodMs, timeoutMs);
		...
		for (int i = 0; i < totalCnt; ++i) {
			...
			point.profileSlotSelect1 = 1; /* auxiliary PID [0,1], leave zero */
