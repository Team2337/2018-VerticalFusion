package com.team2337.robot.commands.auto.motionMagic;
...
public class auto_MMdrive extends Command {
	...
	protected void initialize() {
		...
		RobotMap.chassis_leftFront.set(ControlMode.MotionMagic, distance);
		RobotMap.chassis_rightFront.set(ControlMode.MotionMagic, distance);
		setTimeout(1);
	}
