...
public class commonCG_driveAroundSwitchLeft extends CommandGroup {
	...
	public commonCG_driveAroundSwitchLeft() {
		...
		addSequential(new auto_driveToAngleWithEncoder(.7, 8, 75, 107000, 107000, 0.025, true));
		addSequential(new auto_driveToAngleWithEncoder(.6, 8, 0, 210000, 210000, 0.01)); //187
