...
public class DriveTest {
    ...
    public DriveTest(TalonSRX left, TalonSRX right) {
		this.left = left;
		this.right = right;
	}
    public void cheesyDrive(double throttle, double wheel, boolean isQuickTurn,
        ...
        SmartDashboard.putNumber("leftPwr", leftPwm);
        SmartDashboard.putNumber("rghtPwm", rightPwm);
        this.left.set(ControlMode.PercentOutput, leftPwm);
        this.right.set(ControlMode.PercentOutput, rightPwm);
    }
